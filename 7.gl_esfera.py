...
def display():
    ...
    # GL_DEPTH_BUFFER_BIT define que o buffer será usado
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT)    
    
    rgba = [.8, .6, .4, .9]
    # glMaterial especifica os parâmetros do material usado no modelo de iluminação da cena (no formato RGBA)
    ...
    # Desenha uma esfera sólida, com raio 0.5 e 128 divisões na horizontal e na vertical
    ...
    # GL_DIFFUSE define o parâmetro usado para luz difusa (no formato RGBA)
